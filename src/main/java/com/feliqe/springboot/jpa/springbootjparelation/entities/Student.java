...
public class Student {
    ...
    //indicamos la cardinalidad de la consulta entre JOIN
    ...
    // listar los curso pero usando SET
    ...
    public Student(String name, String lastname) {
        // this(); - llamamos al construnctor de HashSet
        this();
        this.name = name;
    ...
    //funcion de accion de agregar
    public void addCourse(Course course) {
        this.courses.add(course);
        course.getStudents().add(this);
    }

    // funcion de accion de eliminar
